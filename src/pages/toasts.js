        ...
        <div className="example-toast-container">
            ...
            {/* Basic Code Space*/}
                <ComponentPage level={"basic"} scope={{Toast}} componentCode={exampleBasicCode}>
                    <ComponentPage.Text>
                        Add the following code to use the Toast component. Click on your chosen style above to alter the code for your selected style. You can replace the Trigger Code with any text you wish, or any component to act as the trigger. Replace the <span className="prop-name">styleClassName</span> with the classname of your trigger to apply styling.
                        </ComponentPage.Text>
                    <ComponentPage.Playground />
                </ComponentPage>
